(() => {
    ...
    class ClientResponseError extends Error {
        constructor(e) {
            ...
            this.isAbort = !1, this.originalError = null, Object.setPrototypeOf(this, ClientResponseError.prototype), 
            null !== e && "object" == typeof e && (this.url = "string" == typeof e.url ? e.url : "", 
            this.status = "number" == typeof e.status ? e.status : 0, this.isAbort = !!e.isAbort, 
            this.originalError = e.originalError, null !== e.response && "object" == typeof e.response ? this.response = e.response : null !== e.data && "object" == typeof e.data ? this.response = e.data : this.response = {}), 
            ...
            this.name = "ClientResponseError " + this.status, this.message = this.response?.message, 
    ...
    s = "function" != typeof atob || t ? e => {
        ...
        n++ % 4) ? o += String.fromCharCode(255 & s >> (-2 * n & 6)) : 0) i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(i);
        return o;
    } : atob;
    const i = "pb_auth";
    class BaseAuthStore {
        ...
        onChange(e, t = !1) {
            return this._onChangeCallbacks.push(e), t && e(this.token, this.record), () => {
                for (let t = this._onChangeCallbacks.length - 1; t >= 0; t--) if (this._onChangeCallbacks[t] == e) return delete this._onChangeCallbacks[t], 
    ...
    class RealtimeService extends BaseService {
        constructor() {
            super(...arguments), this.clientId = "", this.eventSource = null, this.subscriptions = {}, 
            this.lastSentSubscriptions = [], this.maxConnectTimeout = 15e3, this.reconnectAttempts = 0, 
            this.maxReconnectAttempts = 1 / 0, this.predefinedReconnectIntervals = [ 200, 300, 500, 1e3, 1200, 1500, 2e3 ], 
        ...
        async subscribe(e, t, s) {
            ...
            return this.subscriptions[i] || (this.subscriptions[i] = []), this.subscriptions[i].push(listener), 
        ...
        async unsubscribeByTopicAndListener(e, t) {
            ...
            for (let e in i) {
                ...
                let i = !1;
                for (let s = this.subscriptions[e].length - 1; s >= 0; s--) this.subscriptions[e][s] === t && (i = !0, 
                delete this.subscriptions[e][s], this.subscriptions[e].splice(s, 1), this.eventSource?.removeEventListener(e, t));
        ...
        async submitSubscriptions() {
            if (this.clientId) return this.addAllSubscriptionListeners(), this.lastSentSubscriptions = this.getNonEmptySubscriptionKeys(), 
        ...
        initConnect() {
            ...
            }), this.maxConnectTimeout), this.eventSource = new EventSource(this.client.buildURL("/api/realtime")), 
            this.eventSource.onerror = e => {
                ...
                this.clientId = t?.lastEventId, this.submitSubscriptions().then((async () => {
                    ...
                    this.pendingConnects = [], this.reconnectAttempts = 0, clearTimeout(this.reconnectTimeoutId), 
        ...
        connectErrorHandler(e) {
            if (clearTimeout(this.connectTimeoutId), clearTimeout(this.reconnectTimeoutId), 
        ...
        disconnect(e = !1) {
            if (clearTimeout(this.connectTimeoutId), clearTimeout(this.reconnectTimeoutId), 
            this.removeAllSubscriptionListeners(), this.client.cancelRequest(this.getSubscriptionsCancelKey()), 
            this.eventSource?.close(), this.eventSource = null, this.clientId = "", !e) {
    ...
    class CrudService extends BaseService {
        ...
        async getList(e = 1, t = 30, s) {
            return (s = Object.assign({
                ...
                page: e,
                perPage: t
            }, s.query), this.client.send(this.baseCrudPath, s).then((e => (e.items = e.items?.map((e => this.decode(e))) || [], 
            e)));
        }
    ...
    function normalizeLegacyOptionsArgs(e, t, s, i) {
        const n = void 0 !== i;
        return n || void 0 !== s ? n ? (console.warn(e), t.body = Object.assign({}, t.body, s), 
        t.query = Object.assign({}, t.query, i), t) : Object.assign(t, s) : t;
    }
    ...
    class RecordService extends CrudService {
        ...
        async authWithPassword(e, t, s) {
            ...
            }, s), this.isSuperusers && (i = s.autoRefreshThreshold, delete s.autoRefreshThreshold, 
        ...
        authWithOAuth2(...e) {
            if (e.length > 1 || "string" == typeof e?.[0]) return console.warn("PocketBase: This form of authWithOAuth2() is deprecated and may get removed in the future. Please replace with authWithOAuth2Code() OR use the authWithOAuth2() realtime form as shown in https://pocketbase.io/docs/authentication/#oauth2-integration."), 
        ...
        async confirmVerification(e, t, s) {
            ...
            this.client.send(this.baseCollectionPath + "/confirm-verification", i).then((() => {
                ...
                this.client.authStore.save(this.client.authStore.token, s)), !0;
            }));
        }
    ...
    class FileService extends BaseService {
        ...
        getURL(e, t, s = {}) {
            ...
            const i = [];
            i.push("api"), i.push("files"), i.push(encodeURIComponent(e.collectionId || e.collectionName)), 
            i.push(encodeURIComponent(e.id)), i.push(encodeURIComponent(t));
    ...
    class SubBatchService {
        ...
        prepareRequest(e, t) {
            if (normalizeUnknownQueryParams(t), e.headers = t.headers, e.json = {}, e.files = {}, 
            void 0 !== t.query) {
                const s = serializeQueryParams(t.query);
                s && (e.url += (e.url.includes("?") ? "&" : "?") + s);
            }
            for (const s in t.body) {
                const i = t.body[s];
                if (isFile(i)) e.files[s] = e.files[s] || [], e.files[s].push(i); else if (Array.isArray(i)) {
                    const t = [], n = [];
                    for (const e of i) isFile(e) ? t.push(e) : n.push(e);
                    if (t.length > 0 && t.length == i.length) {
                        e.files[s] = e.files[s] || [];
                        for (let i of t) e.files[s].push(i);
                    } else if (e.json[s] = n, t.length > 0) {
                        let i = s;
                        s.startsWith("+") || s.endsWith("+") || (i += "+"), e.files[i] = e.files[i] || [];
                        for (let s of t) e.files[i].push(s);
                    }
                } else e.json[s] = i;
            }
        }
    ...
    class Client {
        ...
        constructor(e = "/", t, s = "en-US") {
            this.cancelControllers = {}, this.recordServices = {}, this.enableAutoCancellation = !0, 
            this.baseURL = e, this.lang = s, t ? this.authStore = t : "undefined" != typeof window && window.Deno ? this.authStore = new BaseAuthStore : this.authStore = new LocalAuthStore, 
            this.collections = new CollectionService(this), this.files = new FileService(this), 
            this.logs = new LogService(this), this.settings = new SettingsService(this), this.realtime = new RealtimeService(this), 
            this.health = new HealthService(this), this.backups = new BackupService(this);
        }
        get admins() {
        ...
        cancelRequest(e) {
            return this.cancelControllers[e] && (this.cancelControllers[e].abort(), delete this.cancelControllers[e]), 
            this;
        }
        cancelAllRequests() {
        ...
        buildURL(e) {
            ...
            this.baseURL.startsWith("/") || (t += window.location.pathname || "/", t += t.endsWith("/") ? "" : "/"), 
            t += this.baseURL), e && (t += t.endsWith("/") ? "" : "/", t += e.startsWith("/") ? e.substring(1) : e), 
            t;
        }
        async send(e, t) {
            ...
            if (this.beforeSend) {
                ...
                void 0 !== e.url || void 0 !== e.options ? (s = e.url || s, t = e.options || t) : Object.keys(e).length && (t = e, 
        ...
        initSendOptions(e, t) {
            if ((t = Object.assign({
                ...
                return t;
            }(t.body), normalizeUnknownQueryParams(t), t.query = Object.assign({}, t.params, t.query), 
            ...
            delete t.$autoCancel, delete t.query.$autoCancel, delete t.$cancelKey, delete t.query.$cancelKey, 
    ...
    const pb = new Client("https://pocketbase-production-f838.up.railway.app");
    ...
    function formSubmit() {
        ...
        async function formSubmitAction(form, e) {
            ...
            if (error === 0) {
                ...
                const collectionName = form.getAttribute("data-ajax");
                if (ajax) {
                    e.preventDefault();
                    ...
                    switch (collectionName) {
                      case "questions":
                        setTimeout((() => {
                            alert("Запитання успішно надіслано! Очікуйте відповідь на вказану пошту");
                        }), 500);
                        break;

                      case "feedbacks":
                        setTimeout((() => {
                            alert("Відгук успішно надіслано на модерацію!");
                        }), 500);
                        break;
    ...
    function initSliders() {
        if (document.querySelector(".educations__slider")) new swiper_core_Swiper(".educations__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            loop: true,
            navigation: {
                prevEl: ".educations__button-prev",
                nextEl: ".educations__button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
        ...
        if (document.querySelector(".teachers__slider")) new swiper_core_Swiper(".teachers__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    //! Backend
        const script_pb = new Client("https://pocketbase-production-f838.up.railway.app");
    const itemsPerPage = 9;
    function insertInContainer(container, records) {
        let markdown = "";
        for (const element of records.items) {
            ...
            console.log(element);
            markdown += `\n\t\t<div class="feedbacks__item item-feedbacks">\n\t\t\t<img src="img/feedbacks/decor.svg" alt="Декор" class="item-feedbacks__decor">\n\t\t\t<img src="img/feedbacks/quote.svg" alt="Іконка цитати" class="item-feedbacks__icon">\n\t\t\t<div class="item-feedbacks__feedback text">\n\t\t\t\t<p>${element.feedback}</p>\n\t\t\t</div>\n\t\t\t<div class="item-feedbacks__bottom">\n\t\t\t\t<img src="https://pocketbase-production-f838.up.railway.app/api/files/${element.collectionId}/${element.id}/${element.avatar}?token=" title="${element.name} ${element.surname}" alt="Аватарка ${element.name}" class="item-feedbacks__avatar">\n\t\t\t\t<div class="item-feedbacks__about">\n\t\t\t\t\t<div class="item-feedbacks__name">${element.name} ${element.surname}</div>\n\t\t\t\t\t<div class="item-feedbacks__date">${formattedDate}</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>`;
        }
        container.innerHTML = markdown;
    }
    async function fetchFeedbacks(container) {
        const records = await script_pb.collection("feedbacks").getList(1, 3, {
            sort: "-created",
            filter: "approved != False"
        });
        console.log("3");
        console.log(records);
        insertInContainer(container, records);
    }
    async function fetchFeedbacksAll(container, page = 1) {
        try {
            var records = await script_pb.collection("feedbacks").getList(page, itemsPerPage, {
                sort: "-created",
                filter: "approved != False"
            });
            console.log("All");
    ...
    //! pagination for feedbacks
        ...
        const pageNumbersContainer = document.querySelector(".feedbackspage__pagination");
        let currentPage = 1;
        const records = await script_pb.collection("feedbacks").getList(currentPage, itemsPerPage, {
            sort: "-created",
            filter: "approved != False"
        });
        const totalPages = records.totalPages;
        const feedbacksListAll = document.getElementById("all-feedbacks-items");
        if (feedbacksListAll) insertInContainer(feedbacksListAll, records);
        const feedbacksList = document.getElementById("feedbacks-items");
        if (feedbacksList) fetchFeedbacks(feedbacksList);
        if (pageNumbersContainer) {
            ...
            function goToPage(page) {
                if (page >= 1 && page <= totalPages) {
                    ...
                    const feedbacksListAll = document.getElementById("all-feedbacks-items");
                    if (feedbacksListAll) {
                        feedbacksListAll.innerHTML = "";
                        fetchFeedbacksAll(feedbacksListAll, page);
                    }
                    renderPagination();
                }
            }
